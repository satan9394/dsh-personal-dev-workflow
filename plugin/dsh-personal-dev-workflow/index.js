/**
 * dsh-personal-dev-workflow bundle entry: registers the packaged
 * `skills/personal-dev-workflow/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-personal-dev-workflow
 */
...
const PROVIDER_NAME = 'dsh-personal-dev-workflow'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-personal-dev-workflow'
